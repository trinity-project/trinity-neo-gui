...
namespace plugin_trinity.Properties {
    ...
    internal class trinityString {
        ...
        /// <summary>
        ///   查找类似 Current wallet block height is not synchronized 的本地化字符串。
        /// </summary>
        internal static string InvalidBlockHeight {
            get {
                return ResourceManager.GetString("InvalidBlockHeight", resourceCulture);
            }
        }
